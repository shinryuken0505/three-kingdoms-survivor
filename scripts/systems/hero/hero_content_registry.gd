...
const HEROES: Dictionary = {
	...
	"zhugeliang": {"id":"zhugeliang","name":"諸葛亮","faction":"shu","active_skill":"eight_trigrams","reserve_passive":"cooldown_support","growth_profile":"strategist","portrait":"res://assets/portraits/zhuge_liang.png","sprite":"res://assets/heroes/zhugeliang.png"},
	...
	"zhouyu": {"id":"zhouyu","name":"周瑜","faction":"wu","active_skill":"red_cliff_flame","reserve_passive":"cooldown_support","growth_profile":"strategist","portrait":"res://assets/portraits/zhou_yu.png","sprite":"res://assets/heroes/zhouyu.png"},
	...
	"sunshangxiang": {"id":"sunshangxiang","name":"孫尚香","faction":"wu","active_skill":"bow_waist_volley","reserve_passive":"ranged_support","growth_profile":"marksman","portrait":"res://assets/portraits/sun_shang_xiang.png","sprite":"res://assets/heroes/sunshangxiang.png"},
	"diaochan": {"id":"diaochan","name":"貂蟬","faction":"other","active_skill":"closed_moon_charm","reserve_passive":"control_support","growth_profile":"controller","portrait":"res://assets/portraits/diao_chan.png","sprite":"res://assets/heroes/diaochan.png"},
	...
	"zhenji": {"id":"zhenji","name":"甄姬","faction":"wei","active_skill":"luo_river_song","reserve_passive":"control_support","growth_profile":"controller","portrait":"res://assets/portraits/zhen_ji.png","sprite":"res://assets/heroes/zhenji.png"},
	...
	"huatuo": {"id":"huatuo","name":"華佗","faction":"other","active_skill":"qingnang_heal","reserve_passive":"healing_support","growth_profile":"healer","portrait":"res://assets/portraits/hua_tuo.png","sprite":"res://assets/heroes/huatuo.png"},
